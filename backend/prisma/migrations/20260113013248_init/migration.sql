...
-- CreateEnum
CREATE TYPE "ApplicationsType" AS ENUM ('ANNOUNCEMENT', 'TIMECONDITION', 'QUEUE', 'IVR', 'EXTENSION', 'TRUNK', 'SETVARIABLE', 'API', 'HANGUP');
...
CREATE TABLE "inbound_routes" (
    ...
    "description" TEXT,
    "destinationApp" "ApplicationsType" NOT NULL,
...
CREATE TABLE "timeconditions" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "trueDestinationApp" "ApplicationsType" NOT NULL,
    "trueDestinationId" TEXT,
    "falseDestinationApp" "ApplicationsType" NOT NULL,
    "falseDestinationId" TEXT,
    "companyId" TEXT NOT NULL,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "ivrs" (
    ...
    "timeoutDestinationApp" "ApplicationsType" NOT NULL,
    "timeoutDestinationId" TEXT,
    "invalidDestinationApp" "ApplicationsType" NOT NULL,
...
CREATE TABLE "api_requests" (
    ...
    "successDestinationApp" "ApplicationsType" NOT NULL,
    "successDestinationId" TEXT,
    "failureDestinationApp" "ApplicationsType" NOT NULL,
