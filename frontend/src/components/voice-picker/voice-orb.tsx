...
// Porta local (renomeada: Orb -> VoiceOrb, AgentState -> VoiceOrbState) do componente oficial
// "orb" do shadcn/ui (registry ui.elevenlabs.io, WebGL via react-three-fiber), usado só pelo
// VoicePicker (ver voice-picker.tsx) como avatar animado de cada voz.
...
function Scene({
    ...
    const agentRef = useRef<VoiceOrbState>(agentState)
