...
export function FlowNode({
    ...
    return (
        ...
        >
            ...
            {/* wrapper separado dos handles — overflow-hidden aqui clipa o fundo das seções nos
            cantos arredondados do card sem cortar os círculos de handle (que ficam metade fora) */}
